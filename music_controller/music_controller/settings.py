...
SECRET_KEY = 'django-insecure-t9_hp6t7%+gonnmvxt1g=atbr$qp(=lm@l74&ho1!jgvyalw4)'
...
MEDIA_URL = 'music_controller/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'music_controller/media/')